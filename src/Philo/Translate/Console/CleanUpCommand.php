...
class CleanUpCommand extends Command
{
    ...
    {
        $this->progress = $this->getHelperSet()
                               ->get('progress');
    ...
    {
        return [
            ['group', null, InputOption::VALUE_OPTIONAL, 'Clean specific group.'],
            ['silent', null, InputOption::VALUE_NONE, 'Remove missing lines without confirmation'],
        ];
    }
